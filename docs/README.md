...
無料で使える中で E2E ツールとしてもっとも有力だった PlayWright を選定。リリースに関しては既存手順が Windows のため、それに合わせるため Powershell でツールを構築しました。
...
また、当プロジェクトでは手動で画面で操作していたものを API 化するため、対向システムのアカウントを早期に発行してもらい、開発初期から開発者に操作してもらうことでシステム全体の解度を高めてもらいました。
...
サーバサイドエンジニアとして、Ruby on Rails で機能追加を行っております。1on1 支援ツールとして形になっていますが、創業当初は別の形だったようです。『あなたがどこで誰と生きようとも、あなたの持つ人生の可能性を絶対に毀損させない。』という創業以来のコアドメインが変更されることなく、結果として世の中に一番貢献できる形が 1on1 支援ツールとして発展を続けているところに魅力を感じて、参画しました。
