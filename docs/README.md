...
|本業・副業|期間|会社|概要|
|---|---|---|---|
|本業|2019/02-現在|ソフトバンク株式会社|アジャイルでの開発を経験。アジャイルですのでチームリーダーという明確な役割はありません。しかし、技術を伝えたり、アーキテクチャを提案する等でチームメンバーを引っ張りました。|
|本業|2014/04-2019/01|株式会社ISTソフトウェア|2 次受け SIer。官公庁向けシステムに携わってきました。要件定義からリリースまで一気通貫で開発した経験あります。ただし、運用は行ったことはありません。チームでの開発、一人での客先常駐等の様々な経験をしました。|
