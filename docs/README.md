...
開発、PdM、QA、デザイナーを 1 つのチームにまとめたクロスファンクショナルチームを設計・導入しました。職能を混ぜたチームにすることで、助け合いとコミュニケーションが自然と生まれる土壌を作りました。同時にチームを適切な単位に分割することで、必要以上のコミュニケーションコストの増加も防いでいます。

- **その他の取り組み**
    - エンジニア採用を主導
    - 生成 AI の組織導入：運用面では Devin により仕様・不具合問い合わせ対応を効率化し、開発の中断を削減。開発面では Codex, Claude Code を導入
